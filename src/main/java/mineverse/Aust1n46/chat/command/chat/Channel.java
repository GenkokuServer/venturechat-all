...
public class Channel extends MineverseCommand implements Listener {
  ...
  public void execute(CommandSender sender, String command, String[] args) {
    ...
    if (args.length > 0) {
      ...
      plugin.getServer().getPluginManager().callEvent(new ChannelJoinEvent(mcp.getPlayer(), channel,
          "Channel Set: " + ChatColor.valueOf(channel.getColor().toUpperCase()) + "[" + channel.getName() + "]"));
      return;
    }
