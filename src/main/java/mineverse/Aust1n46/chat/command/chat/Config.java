        ...
        switch (args[0]) {
              ...
              switch (args[1]) {
                case "worldeditcommands": {
                  try {
                    ...
                    sender.sendMessage(ChatColor.GREEN + "worldeditcommands: "
                        + plugin.getConfig().getConfigurationSection("commandspy").getBoolean("worldeditcommands"));
                  }
                  break;
                }
              }
              ...
              switch (args[1]) {
                ...
                case "spamnumber": {
                  try {
                    ...
                    sender
                        .sendMessage(ChatColor.GREEN + "spamnumber: " + plugin.getConfig().getConfigurationSection("antispam").getInt("spamnumber"));
                    break;
                  }
                }
                case "spamtime": {
          ...
          case "broadcast": {
            try {
              ...
              sender
                  .sendMessage(ChatColor.GREEN + "permissions: " + plugin.getConfig().getConfigurationSection("broadcast").getString("permissions"));
                  ...
                  switch (args[2]) {
                    case "color": {
                      try {
                        ...
                        sender.sendMessage(
                            ChatColor.GREEN + "color: " + plugin.getConfig().getConfigurationSection("channels." + args[1]).getString("color"));
                        break;
                      }
                    }
                    case "chatcolor": {
                      try {
                        ...
                        sender.sendMessage(ChatColor.GREEN + "chatcolor: "
                            + plugin.getConfig().getConfigurationSection("channels." + args[1]).getString("chatcolor"));
                        break;
                      }
                    }
                    case "mutable": {
                      try {
                        ...
                        sender.sendMessage(
                            ChatColor.GREEN + "mutable: " + plugin.getConfig().getConfigurationSection("channels." + args[1]).getBoolean("mutable"));
                      }
                      break;
                    }
                    case "filter": {
                      try {
                        ...
                        sender.sendMessage(
                            ChatColor.GREEN + "filter: " + plugin.getConfig().getConfigurationSection("channels." + args[1]).getBoolean("filter"));
                      }
                      break;
                    }
                    case "permissions": {
                      try {
                        ...
                        sender.sendMessage(ChatColor.GREEN + "permissions: "
                            + plugin.getConfig().getConfigurationSection("channels." + args[1]).getString("permissions"));
                        break;
                      }
                    }
                    case "alias": {
                      try {
                        ...
                        sender.sendMessage(
                            ChatColor.GREEN + "alias: " + plugin.getConfig().getConfigurationSection("channels." + args[1]).getString("alias"));
                        break;
                      }
                    }
                    case "default": {
                      try {
                        ...
                        sender.sendMessage(
                            ChatColor.GREEN + "default: " + plugin.getConfig().getConfigurationSection("channels." + args[1]).getBoolean("default"));
                      }
                      break;
                    }
                    case "autojoin": {
                      try {
                        ...
                        sender.sendMessage(ChatColor.GREEN + "autojoin: "
                            + plugin.getConfig().getConfigurationSection("channels." + args[1]).getBoolean("autojoin"));
                      }
                      break;
                    }
                    case "distance": {
                    ...
                    case "cooldown": {
                      try {
                        ...
                        sender.sendMessage(
                            ChatColor.GREEN + "cooldown: " + plugin.getConfig().getConfigurationSection("channels." + args[1]).getInt("cooldown"));
                        break;
                      }
                    }
                    case "bungeecord": {
                      try {
                        ...
                        sender.sendMessage(ChatColor.GREEN + "bungeecord: "
                            + plugin.getConfig().getConfigurationSection("channels." + args[1]).getBoolean("bungeecord"));
                      }
                      break;
                    }
                    case "format": {
                      try {
                        ...
                        sender.sendMessage(
                            ChatColor.GREEN + "format: " + plugin.getConfig().getConfigurationSection("channels." + args[1]).getString("format"));
                        break;
                      }
                    }
                    default: {
