    ...
    if (sender.hasPermission("venturechat.chatinfo")) {
      if (args.length == 0) {
        ...
        if (args.length < 1) {
          ...
          if (mcp.hasConversation()) {
            mcp.getPlayer().sendMessage(ChatColor.GOLD + "Private conversation: " + ChatColor.GREEN
      ...
      if (sender.hasPermission("venturechat.chatinfo.others")) {
        ...
        if (p.hasConversation()) {
          sender.sendMessage(
              ChatColor.GOLD + "Private conversation: " + ChatColor.GREEN + MineverseChatAPI.getMineverseChatPlayer(p.getConversation()).getName());
        } else {
