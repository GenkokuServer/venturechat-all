        ...
        if (args.length > 0) {
          ...
          if (plugin.getConfig().getString("replyformatto").equalsIgnoreCase("Default")) {
            ...
            echo = Format.FormatStringAll(
                plugin.getConfig().getString("replyformatto").replace("{playerto}", player.getNickname()).replace("{playerfrom}", mcp.getNickname()))
                + msg;
          }
          if (plugin.getConfig().getString("replyformatfrom").equalsIgnoreCase("Default")) {
            ...
            send = Format.FormatStringAll(plugin.getConfig().getString("replyformatfrom").replace("{playerto}", player.getNickname())
                .replace("{playerfrom}", mcp.getNickname())) + msg;
          }
          if (plugin.getConfig().getString("replyformatspy").equalsIgnoreCase("Default")) {
            ...
            spy = Format.FormatStringAll(
                plugin.getConfig().getString("replyformatspy").replace("{playerto}", player.getName()).replace("{playerfrom}", mcp.getName())) + msg;
          }
