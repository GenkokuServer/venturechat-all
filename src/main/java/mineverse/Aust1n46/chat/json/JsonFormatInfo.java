...
public class JsonFormatInfo {
  ...
  public JsonFormatInfo(MineverseChat plugin) {
    ...
    for (String key : cs.getKeys(false)) {
      ...
      JsonFormat j = new JsonFormat(name, priority, hoverTextName, clickName, clickNameText, hoverTextPrefix, clickPrefix, clickPrefixText,
          clickSuffix, clickSuffixText, hoverTextSuffix);
      jf[x++] = j;
    }
  }
